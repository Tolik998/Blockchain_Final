...
export function ClaimsPage() {
  ...
  async function submit() {
    ...
    try {
      ...
      if (!isConfigured(CONTRACTS.claim)) {
        throw new Error('Configure claim processor address first');
      }
  ...
  return (
    <div className="space-y-6 max-w-xl">
      ...
      <p className="text-slate-400 text-sm">
        Anyone can call{' '}
        <code className="text-accent">processClaim</code>{' '}
        when the Chainlink feed satisfies the policy trigger and
